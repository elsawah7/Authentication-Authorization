...
<body class="bg-gray-900 text-gray-200">
    ...
    <div class="container mx-auto mt-10 p-2">
        <div class="flex justify-between items-center mb-4">
            ...
            @hasPermissionTo(\App\Enums\PermissionEnum::CREATE_ROLE->value)
                    ...
                    @foreach ($roles as $role)
                        <tr class="hover:bg-gray-700">
                            ...
                            <td class="p-3 border-b border-gray-700">
                                @hasPermissionTo(\App\Enums\PermissionEnum::UPDATE_ROLE->value)
                                    <button
                                ...
                                @endhasPermissionTo
                                @hasPermissionTo(\App\Enums\PermissionEnum::DELETE_ROLE->value)
