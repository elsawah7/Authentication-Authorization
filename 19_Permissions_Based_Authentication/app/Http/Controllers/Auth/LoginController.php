...
class LoginController extends Controller
{
    ...
    public function __invoke(LoginRequest $request)
    {
        ...
        if (!$user->account_verified_at) {
            ...
            return redirect()->route('account.verify', $user->identifier)->with('info', 'Please verify your account.');
        }
        ...
        return redirect()->intended($url[$user->role] ?? '/profile')->with('success', 'Logged in successfully.');
    }
}
